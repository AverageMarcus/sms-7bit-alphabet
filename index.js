...
module.exports = {
  encode: (msg) => {
    ...
    for (const char of msg) {
      ...
      response.push(encodeTable[code]);
    }
  ...
  decode: (msg) => {
    ...
    while(code = msg.shift()) {
      ...
      response.push(String.fromCharCode(decodeTable[code]));
    }
    return response.join('');
  }
};
